import{n as e}from"./glsl-CHAh5tEH.js";import{t}from"./Matrix3PassUniform-XxFQzHVr.js";import{t as n}from"./Float3PassUniform-DL2u3U8R.js";import{n as r}from"./VisualVariablePassParameters-BOBtYkZy.js";import{t as i}from"./Float4PassUniform-lh-dPatj.js";import{t as a}from"./FloatsPassUniform-BGlxT3as.js";function o(t){t.code.add(e`struct MaskedColor {
vec4 color;
bvec4 mask;
...
}`)}function u(s,u){let{vertex:d,attributes:f}=s;u.hasVVInstancing&&(u.hasVVSize||u.hasVVColor)&&f.add(`instanceFeatureAttribute`,`vec4`),u.hasVVSize?(d.uniforms.add(new n(`vvSizeMinSize`,e=>e.vvSize.minSize)),d.uniforms.add(new n(`vvSizeMaxSize`,e=>e.vvSize.maxSize)),d.uniforms.add(new n(`vvSizeOffset`,e=>e.vvSize.offset)),d.uniforms.add(new n(`vvSizeFactor`,e=>e.vvSize.factor)),d.uniforms.add(new n(`vvSizeFallback`,e=>e.vvSize.fallback)),d.uniforms.add(new t(`vvSymbolRotationMatrix`,e=>e.vvSymbolRotationMatrix)),d.uniforms.add(new n(`vvSymbolAnchor`,e=>e.vvSymbolAnchor)),d.code.add(e`vec3 vvScale(vec4 _featureAttribute) {
...
vec4 vvLocalNormal(vec3 _normal) { return vec4(_normal, 1.0); }`),s.vertex.include(o),u.hasVVColor?(d.constants.add(`vvColorNumber`,`int`,8),d.uniforms.add(new a(`vvColorValues`,8,e=>e.vvColor.values),new r(`vvColorColors`,8,e=>e.vvColor.colors),new i(`vvColorFallback`,e=>e.vvColor.fallback,{supportsNaN:!0})),u.hasVVInstancing&&(s.vertex.include(c),s.vertex.include(l)),d.code.add(e`
