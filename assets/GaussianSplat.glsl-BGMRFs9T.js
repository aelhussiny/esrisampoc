import{r as e}from"./tslib.es6-CQo_GpaT.js";import{y as t}from"./vec2-fXrlejFD.js";import{c as n}from"./vec3f64-C-UKe46_.js";import{i as r}from"./vec2f64-vR6k7VCu.js";import{n as i,t as a}from"./glsl-CHAh5tEH.js";import{t as o}from"./Float2PassUniform-C0auDrhO.js";import{t as s}from"./FloatPassUniform-BGNunQwI.js";import{t as c}from"./NoParameters-x88d7FbV.js";import{t as l}from"./ShaderBuilder-HdHfSgzd.js";import{n as u,t as d}from"./ShaderTechniqueConfiguration-CH-PemgK.js";import{t as f}from"./Float3BindUniform-D21sCeTc.js";import{t as p}from"./Float3PassUniform-DL2u3U8R.js";import{t as m}from"./Matrix4BindUniform-o4jYbzYw.js";import{t as h}from"./Float2BindUniform-sYd1gZGw.js";import{t as g}from"./TerrainDepthTest.glsl-BvZ9_Dq8.js";import{t as _}from"./PositionOutsideClipSpace-CEMoNqkh.js";import{n as v,r as y,t as b}from"./EvaluateSceneLighting.glsl-DBOQi6Gp.js";import{t as x}from"./Texture2DUintPassUniform-KJSCg93M.js";import{bt as S}from"./index-gOtVMHtj.js";import{t as C}from"./RgbNormalizedDepthEncoding.glsl-n9yHevrf.js";function w(e){e.code.add(i`void computeCovariance3D(in mat3 rotation, in vec3 scale, out vec3 covarianceA, out vec3 covarianceB) {
...
}`)}var T=class extends c{constructor(){super(...arguments),this.tileCameraPosition=n(),this.cameraDelta=n()}};function E(e){e.code.add(i`vec4 unpackColor(uvec4 packedGaussian) {
vec4 color;
...
return color / 255.0;
}`),e.code.add(i`vec3 unpackScale(uvec4 packedGaussian) {
...
}`),e.code.add(i`const uint MASK_9_BITS = 0x1FFu;
...
return quaternion;
}`),e.code.add(i`vec3 unpackTileOriginRelativePosition(uvec4 packedGaussian) {
...
}`),e.uniforms.add(new p(`tileCameraPosition`,e=>e.tileCameraPosition),new p(`cameraDelta`,e=>e.cameraDelta)).code.add(i`vec3 unpackCameraRelativeGaussianPosition(uvec4 packedHeader, highp vec3 position) {
...
}`)}function D(e){e.code.add(i`mat3 quaternionToRotationMatrix(vec4 q) {
float x2 = q.x + q.x;
float y2 = q.y + q.y;
float z2 = q.z + q.z;
float xx = x2 * q.x;
...
}`)}var O=class extends d{constructor(e){super(),this.spherical=e,this.alphaCutoff=1,this.fadingEnabled=!1,this.terrainDepthTest=!1,this.cullAboveTerrain=!1,this.occlusionPass=!1,this.receiveAmbientOcclusion=!1,this.pbrMode=0,this.useCustomDTRExponentForWater=!1,this.useFillLights=!1,this.hasColorTexture=!0}};function k(e){switch(e){case 2:return .005;case 0:return .05;default:return .01}}e([u({count:3})],O.prototype,`alphaCutoff`,void 0),e([u()],O.prototype,`fadingEnabled`,void 0),e([u()],O.prototype,`terrainDepthTest`,void 0),e([u()],O.prototype,`cullAboveTerrain`,void 0),e([u()],O.prototype,`receiveAmbientOcclusion`,void 0);var A=class extends T{constructor(){super(...arguments),this.focalLength=-1,this.minSplatRadius=-1,this.tanFov=r()}};function j(e){let n=new l;n.varyings.add(`vColor`,`vec4`),n.varyings.add(`conicOpacity`,`vec4`),n.varyings.add(`offsetFromCenter`,`vec2`),n.vertex.uniforms.add(new x(`splatOrderTexture`,e=>e.splatOrder),new x(`splatFadingTexture`,e=>e.splatFading),new x(`splatAtlasTexture`,e=>e.splatAtlas),new s(`focalLength`,e=>e.focalLength),new s(`minSplatRadius`,e=>e.minSplatRadius),new o(`tanFov`,e=>e.tanFov),new h(`screenSize`,({camera:e})=>t(M,e.fullWidth,e.fullHeight)),new m(`proj`,e=>e.camera.projectionMatrix),new m(`view`,e=>e.camera.viewMatrix),new h(`nearFar`,e=>e.camera.nearFar),new f(`cameraPosition`,e=>e.camera.eye)),n.vertex.include(E),n.vertex.include(D),n.vertex.include(w),n.vertex.include(y,e),n.include(S,e),v(n.vertex),b(n.vertex),n.include(g,e),n.outputs.add(`fragColor`,`vec4`,0),n.outputs.add(`fragDepthColor`,`vec4`,1);let r=k(e.alphaCutoff),c=Math.log(r),u=-2*c;return n.vertex.code.add(i`vec2 ndcToPixel(vec2 ndcCoord, vec2 screenSize) {
